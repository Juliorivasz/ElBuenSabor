...
const NuevoEmpleadoForm: React.FC<NuevoEmpleadoFormProps> = ({ onSuccess, onCancel, showHeader = true }) => {
  const [formData, setFormData] = useState<NuevoEmpleadoDto>({
    nombre: "",
    apellido: "",
    email: "",
    telefono: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dataToSend: NuevoEmpleadoDto = {
        ...formData,
        direccion: {
          ...formData.direccion,
      ...
      await empleadoServicio.crearEmpleado(dataToSend)
      ...
      // Callback de éxito (para refrescar tabla, cerrar modal, etc.)
      onSuccess?.()
    } catch (error) {
    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      {showHeader && (
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
          ...
          <p className="text-blue-100 mt-1">Registra un nuevo empleado en el sistema</p>
        </div>
      )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-white text-gray-900 placeholder-gray-500 ${
            ...
            <div>
              ...
              <select
                ...
                value={formData.rol}
                onChange={handleInputChange}
                className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-white text-gray-900 ${
              ...
              >
                ...
                <option value={Rol.ADMINISTRADOR} className="text-gray-900">
                  Administrador
                </option>
                <option value={Rol.CAJERO} className="text-gray-900">
                  Cajero
                </option>
                <option value={Rol.COCINERO} className="text-gray-900">
                  Cocinero
                </option>
                <option value={Rol.REPARTIDOR} className="text-gray-900">
                  Repartidor
                </option>
              </select>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-white text-gray-900 placeholder-gray-500"
                placeholder="Piso"
              />
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
          ...
          {onCancel && (
            <button
              ...
              disabled={isLoading}
              className="flex-1 bg-red-500 text-white py-2 px-4 rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            >
              Cancelar
            </button>
          )}
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>El empleado recibirá credenciales de acceso por email</li>
              </ul>
            </div>
          </div>
        </div>
