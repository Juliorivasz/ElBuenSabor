    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
      <div className="relative top-8 mx-auto p-6 border w-11/12 max-w-3xl shadow-xl rounded-lg bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Columna Derecha - Subcategorías y Estadísticas Adicionales */}
          <div className="space-y-6">
            {/* Subcategorías */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
            ...
            {/* Estadísticas adicionales (ahora en la columna derecha) */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
                <div className="bg-white bg-opacity-50 p-3 rounded">
                  ...
                  <div className="text-xs mt-1">
                    {categoria.esCategoriaPadre()
                      ? `Categoría principal con ${subcategorias.length} subcategoría${
                ...
                <div className="bg-white bg-opacity-50 p-3 rounded col-span-full">
