...
interface PromotionsFiltersProps {
  ...
  filtroActual: "todas" | "activas" | "inactivas"
  onFiltroChange: (filtro: "todas" | "activas" | "inactivas") => void
  busqueda: string
...
export const PromotionsFilters = ({
  ...
  const tabs = [
    ...
    },
    {
      ...
      description: "Solo promociones activas",
    },
    {
      key: "inactivas" as const,
      label: "Inactivas",
      count: promocionesInactivas,
      color: "bg-red-100 text-red-800 border-red-200",
      description: "Solo promociones inactivas",
    },
  ]
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Buscar promociones en tiempo real..."
            />
            {searchTerm && (
