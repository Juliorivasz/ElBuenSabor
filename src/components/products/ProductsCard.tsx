...
export const ProductsCard: React.FC<ProductCardProps> = memo(({ product, onClick }) => {
  return (
    <div
      onClick={onClick}
      ...
      <div className="h-40 bg-gray-300 rounded-lg mb-3 relative overflow-hidden">
        <img
          ...
          className={`w-full h-full object-cover ${product.getDetalles().length !== 0 ? "" : "grayscale-100"}`}
          loading="lazy"
          decoding="async"
        />
