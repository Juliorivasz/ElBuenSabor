          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center mt-2 space-x-4">
                ...
                >
                  <span
                    className={`w-2 h-2 rounded-full mr-2 ${rubro.isDadoDeAlta() ? "bg-green-400" : "bg-red-400"}`}
                  ></span>
                ...
                {subrubros.length > 0 ? (
                  <div className="divide-y divide-gray-200">
                    {subrubros.map((subrubro) => (
                      <div key={subrubro.getIdRubroInsumo()} className="p-4 hover:bg-gray-50 transition-colors">
                        <div className="flex items-center space-x-3">
                          <FolderIcon className="h-8 w-8 text-orange-600" />
