...
import { RefreshOutlined, LocalShippingOutlined, CheckCircleOutlined } from "@mui/icons-material"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center">
            <LocalShippingOutlined className="text-black mr-3" fontSize="large" />
            <div>
        ...
        <div className="mb-8">
          <div className="bg-green-100 rounded-lg shadow-sm border border-green-200 p-6">
            <h2 className="text-xl font-bold text-green-800 mb-4">
              ...
              Pedidos Listos para Retirar</h2>
