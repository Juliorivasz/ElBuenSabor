...
export const Register: React.FC = () => {
  ...
  const localidadesDisponibles = formData.departamento
    ? departamentosConLocalidades[formData.departamento]
    : [];
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-orange-100">
      ...
      >
        ...
        <div className="mb-6">
          <label htmlFor="departamento" className="block text-md text-gray-700 mb-1">
            Departamento
          </label>
          <select
            name="departamento"
        ...
        <div className="mb-6">
          <label htmlFor="localidad" className="block text-md text-gray-700 mb-1">
            Localidad
          </label>
          <select
            name="localidad"
