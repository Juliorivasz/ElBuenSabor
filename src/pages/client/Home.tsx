    ...
    <section className="flex flex-col md:flex-row justify-between items-center px-6 py-12 text-black">
      <div className="max-w-6xl mx-auto w-full flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <Link to={"/catalog"}>
            <button className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4  mt-4 w-60 h-15 rounded-full cursor-pointer transition-colors duration-300 ease-in-out">
              CATALOGO
            </button>
          </Link>
        </div>
