...
export const Profile: React.FC = () => {
  ...
  const isSocialLoginUser = (): boolean => {
    if (!user?.sub) return false
    // Auth0 social OAuth users have sub starting with provider identifier
    return (
      user.sub.startsWith("google-oauth2|") ||
      user.sub.startsWith("oauth2|google") ||
      user.sub.startsWith("facebook|") ||
      user.sub.startsWith("oauth2|facebook")
    )
  }
                ...
                >
                  <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                    <div className="p-1.5 sm:p-2 bg-orange-100 rounded-lg flex-shrink-0">
                      <field.icon className="text-orange-600" sx={{ fontSize: { xs: 20, sm: 24 } }} />
                    </div>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className="p-2 bg-orange-100 rounded-lg">
                        <field.icon className="text-orange-600" sx={{ fontSize: 24 }} />
                      </div>
                      <div>
